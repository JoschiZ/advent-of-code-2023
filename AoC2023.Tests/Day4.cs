...
public class Day4
{
    ...
    public void Should_Calculate_Correct_Points(string inputLine, double solution)
    {
        var result = AdventOfCode2023.DayFour.Day4.SolveFirst(new[] { inputLine });
    ...
    public void Should_Solve_Second()
    {
        var input = """
                    ...
                    """;
        var result = AdventOfCode2023.DayFour.Day4.SolveSecond(input.Split("\n"));
